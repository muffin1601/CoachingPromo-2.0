const poloTshirts = [
  {
    ...
    subImages: [
      { url: "/assets/polotshirts/1.webp", altText: "Front View" },
      { url: "/assets/polotshirts/2.webp", altText: "Back View" },
      { url: "/assets/polotshirts/3.webp", altText: "Collar Close-up" },
      { url: "/assets/polotshirts/4.webp", altText: "Fabric Texture" }
    ],
    stock: 800,
    sku: "POLO-001",
    attributes: {
      color: ["White", "Navy Blue", "Black", "Red"],
      size: ["S", "M", "L", "XL", "XXL"],
...

  {
    ...
    subImages: [
      { url: "/assets/polotshirts/5.webp", altText: "Front View" },
      { url: "/assets/polotshirts/6.webp", altText: "Back Print" },
      { url: "/assets/polotshirts/7.webp", altText: "Sleeve Detail" },
      { url: "/assets/polotshirts/8.webp", altText: "Collar Detail" }
    ],
    stock: 600,
    sku: "POLO-002",
    attributes: {
      color: ["Blue", "Royal Blue", "Black", "Grey"],
      size: ["S", "M", "L", "XL", "XXL"],
...

  {
    ...
    subImages: [
      { url: "/assets/polotshirts/9.webp", altText: "Front View" },
      { url: "/assets/polotshirts/10.webp", altText: "Back View" },
      { url: "/assets/polotshirts/11.webp", altText: "Sports Fabric" },
      { url: "/assets/polotshirts/12.webp", altText: "Side Panel Detail" }
    ],
    stock: 700,
    sku: "POLO-003",
    attributes: {
    ...
    tags: ["sports", "team", "dryfit", "polo tshirt"],
    isFeatured: true,
    isActive: true,
...

  {
    ...
    subImages: [
      { url: "/assets/polotshirts/13.webp", altText: "Front View" },
      { url: "/assets/polotshirts/14.webp", altText: "Back Logo" },
      { url: "/assets/polotshirts/15.webp", altText: "Breathable Fabric" },
      { url: "/assets/polotshirts/16.webp", altText: "Stitch Detail" }
    ],
    stock: 450,
    sku: "POLO-004",
    attributes: {
      ...
      size: ["S", "M", "L", "XL"],
      material: "Sports Mesh Fabric",
    },
    tags: ["sports uniform", "team polo"],
    isFeatured: false,
    isActive: true,
...

  {
    ...
    subImages: [
      { url: "/assets/polotshirts/17.webp", altText: "Front" },
      { url: "/assets/polotshirts/18.webp", altText: "Back" },
      { url: "/assets/polotshirts/19.webp", altText: "Collar Close-up" },
      { url: "/assets/polotshirts/20.webp", altText: "Logo Print" }
    ],
    stock: 900,
    sku: "POLO-005",
    attributes: {
...

  {
    ...
    price: 469,
    salePrice: 429,
    images: [{ url: "/assets/polotshirts/21.webp", altText: "Cotton Polo T-Shirt" }],
    subImages: [
      { url: "/assets/polotshirts/21.webp", altText: "Front" },
      { url: "/assets/polotshirts/22.webp", altText: "Back" },
      { url: "/assets/polotshirts/23.webp", altText: "Fabric Zoom" },
      { url: "/assets/polotshirts/24.webp", altText: "Sleeve Detail" }
    ],
    stock: 1000,
    sku: "POLO-006",
    attributes: {
      color: ["White", "Maroon", "Blue"],
      size: ["S", "M", "L", "XL"],
      material: "100% Cotton",
    },
  ...
  // LAST 3 — Only 3 subimages
  {
    ...
    subImages: [
      { url: "/assets/polotshirts/25.webp", altText: "Front" },
      { url: "/assets/polotshirts/26.webp", altText: "Back Print" },
      { url: "/assets/polotshirts/27.webp", altText: "Fabric Print" }
    ],
    stock: 700,
    sku: "POLO-007",
    attributes: {
      color: ["White", "Black", "Custom Print"],
      size: ["S", "M", "L", "XL"],
...

  {
    ...
    price: 599,
    salePrice: 549,
    images: [{ url: "/assets/polotshirts/28.webp", altText: "Premium Polo T-Shirt" }],
    subImages: [
      { url: "/assets/polotshirts/28.webp", altText: "Front" },
      { url: "/assets/polotshirts/29.webp", altText: "Back" },
      { url: "/assets/polotshirts/30.webp", altText: "Premium Fabric" }
    ],
    stock: 300,
    sku: "POLO-008",
    attributes: {
      color: ["Black", "Gold", "Navy Blue"],
      size: ["M", "L", "XL", "XXL"],
      material: "Premium Cotton-Lycra Blend",
    },
    tags: ["premium", "faculty wear", "polo tshirt"],
    isFeatured: true,
    isActive: true,
    ratings: { average: 4.9, count: 170 },
    seo: {
...

  {
    ...
    subImages: [
      { url: "/assets/polotshirts/31.webp", altText: "Front" },
      { url: "/assets/polotshirts/32.webp", altText: "Event Print" },
      { url: "/assets/polotshirts/33.webp", altText: "Collar Stitching" }
    ],
    stock: 650,
    sku: "POLO-009",
    attributes: {
    ...
    tags: ["event tshirt", "branding", "polo"],
    isFeatured: false,
    isActive: true,
