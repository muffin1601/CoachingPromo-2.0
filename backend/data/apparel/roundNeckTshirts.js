const roundNeckTshirts = [
  {
    ...
    subImages: [
      { url: "/assets/roundnecktshirts/1.webp", altText: "Front View" },
      { url: "/assets/roundnecktshirts/2.webp", altText: "Back View" },
      { url: "/assets/roundnecktshirts/3.webp", altText: "Print Close-up" }
    ],
    stock: 900,
    sku: "RNT-001",
    attributes: {
...

  {
    ...
    subImages: [
      { url: "/assets/roundnecktshirts/4.webp", altText: "Front View" },
      { url: "/assets/roundnecktshirts/5.webp", altText: "Back Print" },
      { url: "/assets/roundnecktshirts/6.webp", altText: "Fabric Close-up" }
    ],
    stock: 850,
    sku: "RNT-002",
    attributes: {
  ...
  {
    name: "Sports Round Neck T-Shirts",
    slug: "sports-round-neck-tshirts",
    description:
      "High-quality Sports Round Neck T-Shirts crafted for comfort and performance — perfect for sports events, training sessions, and team identity.",
    price: 349,
    salePrice: 299,
    images: [{ url: "/assets/roundnecktshirts/7.webp", altText: "Sports Round Neck T-Shirt" }],
    subImages: [
      { url: "/assets/roundnecktshirts/7.webp", altText: "Front View" },
      { url: "/assets/roundnecktshirts/8.webp", altText: "Back View" },
      { url: "/assets/roundnecktshirts/9.webp", altText: "Sports Fabric Close-up" }
    ],
    stock: 700,
    sku: "RNT-003",
    attributes: {
    ...
    tags: ["sports", "team tshirt", "dryfit"],
    isFeatured: true,
    isActive: true,
...

  {
    ...
    subImages: [
      { url: "/assets/roundnecktshirts/10.webp", altText: "Front" },
      { url: "/assets/roundnecktshirts/11.webp", altText: "Back" },
      { url: "/assets/roundnecktshirts/12.webp", altText: "Logo Print Detail" }
    ],
    stock: 600,
    sku: "RNT-004",
    attributes: {
    ...
    tags: ["sports uniform", "team tshirt"],
    isFeatured: false,
    isActive: true,
...

  {
    ...
    subImages: [
      { url: "/assets/roundnecktshirts/13.webp", altText: "Front" },
      { url: "/assets/roundnecktshirts/14.webp", altText: "Back" },
      { url: "/assets/roundnecktshirts/15.webp", altText: "Print Detail" }
    ],
    stock: 1000,
    sku: "RNT-005",
    attributes: {
...

  {
    ...
    price: 319,
    salePrice: 289,
    images: [{ url: "/assets/roundnecktshirts/16.webp", altText: "Cotton Round Neck T-Shirt" }],
    subImages: [
      { url: "/assets/roundnecktshirts/16.webp", altText: "Front" },
      { url: "/assets/roundnecktshirts/17.webp", altText: "Back" },
      { url: "/assets/roundnecktshirts/18.webp", altText: "Fabric Texture" }
    ],
    stock: 1100,
    sku: "RNT-006",
    attributes: {
      color: ["White", "Maroon", "Navy Blue"],
      size: ["S", "M", "L", "XL"],
      material: "100% Cotton",
    },
    tags: ["cotton", "round neck tshirt"],
    isFeatured: false,
    isActive: true,
...

  {
    ...
    subImages: [
      { url: "/assets/roundnecktshirts/19.webp", altText: "Front" },
      { url: "/assets/roundnecktshirts/20.webp", altText: "Back Print" },
      { url: "/assets/roundnecktshirts/21.webp", altText: "Graphic Detail" }
    ],
    stock: 750,
    sku: "RNT-007",
    attributes: {
...

  {
    ...
    price: 349,
    salePrice: 309,
    images: [{ url: "/assets/roundnecktshirts/22.webp", altText: "Premium Round Neck T-Shirt" }],
    subImages: [
      { url: "/assets/roundnecktshirts/22.webp", altText: "Front" },
      { url: "/assets/roundnecktshirts/23.webp", altText: "Back" },
      { url: "/assets/roundnecktshirts/24.webp", altText: "Premium Fabric Close-up" }
    ],
    stock: 400,
    sku: "RNT-008",
    attributes: {
...

  {
    ...
    subImages: [
      { url: "/assets/roundnecktshirts/25.webp", altText: "Front" },
      { url: "/assets/roundnecktshirts/26.webp", altText: "Event Print" },
      { url: "/assets/roundnecktshirts/27.webp", altText: "Collar Detail" }
    ],
    stock: 680,
    sku: "RNT-009",
    attributes: {
    ...
    tags: ["event tshirt", "branding tshirt"],
    isFeatured: false,
    isActive: true,
