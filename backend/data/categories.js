        ...
        products: [
          {
            ...
            slug: "executive-diary-product",
            description: "A premium, hardbound diary/planner (dated or undated) with a customizable cover and inner pages.",
            price: 12.99,
            salePrice: 10.99,
            images: [{ url: "/assets/diary.png", altText: "Custom Executive Diary" }],
            stock: 950,
            sku: "STA-DRY-019",
            attributes: {
              color: ["Black", "Brown", "Blue", "Custom"],
              size: ["A5", "A4"],
              material: "Leatherette/Hardbound Paper",
            },
            tags: ["stationery", "diary", "gift", "planning"],
            isFeatured: true,
            isActive: true,
            ratings: {
              average: 4.8,
            ...
            seo: {
              metaTitle: "Buy Branded Executive Diaries",
              metaDescription: "Corporate year-end diaries and planners for bulk order.",
              keywords: ["business planner", "journal notebook", "dated diary"],
            },
          },
        ],
      },
