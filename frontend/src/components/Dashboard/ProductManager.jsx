...
const ProductManager = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      if (editId) {
        await axios.put(`${import.meta.env.VITE_API_URL}/products/update/${editId}`, payload);
        alert("Product updated ✅");
      } else {
        await axios.post(`${import.meta.env.VITE_API_URL}/products/create`, payload);
  ...
  const uploadSingle = async (file) => {
    ...
    const res = await axios.post(`${import.meta.env.VITE_API_URL}/products/upload`, fd, {
